...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || '2432902665@qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/schrolemons',
    },
  ],
